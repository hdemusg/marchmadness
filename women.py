...
def flip(row):
    swaps = [('Seed 1', 'Seed 2'), ('Team 1', 'Team 2'), ('Offense 1', 'Offense 2'), ('Defense 1', 'Defense 2'), ('Win Pct 1', 'Win Pct 2'), ('Score 1', 'Score 2')]
    for swap in swaps:
...
def generate_bracket(output_file, model_name, name):
    ...
    template = "templates/2025w.csv"
    final_training = pd.read_csv("data/trainw.csv", index_col=0)
    ...
    x_vars = ['Round Score', 'Seed 1', 'Seed 2', 'Offense 1', 'Offense 2', 'Defense 1', 'Defense 2', 'Win Pct 1', 'Win Pct 2']
    y_vars = ['Score 1', 'Score 2']

    for run in range(1, 6):
        # create training and test split of the pre-2022 data
        #print(final_training.columns)
        data_x = final_training[['Round', 'Round Score', 'Seed 1', 'Seed 2', 'Offense 1', 'Offense 2', 'Defense 1', 'Defense 2', 'Win Pct 1', 'Win Pct 2']]
    ...
    if ff1_pred[0] <= ff1_pred[1]:
        ...
        bracket.iat[4, bracket.columns.get_loc('Team 2')] = ff1_team2.values[0]
        bracket.iat[4, bracket.columns.get_loc('Offense 2')] = bracket.iloc[0][['Offense 2']]
        bracket.iat[4, bracket.columns.get_loc('Defense 2')] = bracket.iloc[0][['Defense 2']]
        ...
        bracket.iat[4, bracket.columns.get_loc('Team 2')] = ff1_team1.values[0]
        bracket.iat[4, bracket.columns.get_loc('Offense 2')] = bracket.iloc[0][['Offense 1']]
        bracket.iat[4, bracket.columns.get_loc('Defense 2')] = bracket.iloc[0][['Defense 1']]
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[4, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[0][['Win Pct 1']].values[0]

    # First Four
    firstfour_2 = bracket.iloc[1][x_vars]
    ...
    if ff2_pred[0] <= ff2_pred[1]:
        ...
        bracket.iat[28, bracket.columns.get_loc('Team 2')] = ff2_team2.values[0]
        bracket.iat[28, bracket.columns.get_loc('Offense 2')] = bracket.iloc[1][['Offense 2']]
        bracket.iat[28, bracket.columns.get_loc('Defense 2')] = bracket.iloc[1][['Defense 2']]
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[28, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[1][['Win Pct 2']].values[0]
        ...
        bracket.iat[28, bracket.columns.get_loc('Team 2')] = ff2_team1.values[0]
        bracket.iat[28, bracket.columns.get_loc('Offense 2')] = bracket.iloc[1][['Offense 1']]
        bracket.iat[28, bracket.columns.get_loc('Defense 2')] = bracket.iloc[1][['Defense 1']]     
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[28, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[1][['Win Pct 1']].values[0]
    ...
    if ff3_pred[0] <= ff3_pred[1]:
        ...
        bracket.iat[32, bracket.columns.get_loc('Team 2')] = ff3_team2.values[0]
        bracket.iat[32, bracket.columns.get_loc('Offense 2')] = bracket.iloc[2][['Offense 2']]
        bracket.iat[32, bracket.columns.get_loc('Defense 2')] = bracket.iloc[2][['Defense 2']]
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[32, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[2][['Win Pct 2']].values[0]
        ...
        bracket.iat[32, bracket.columns.get_loc('Team 2')] = ff3_team1.values[0]
        bracket.iat[32, bracket.columns.get_loc('Offense 2')] = bracket.iloc[2][['Offense 1']]
        bracket.iat[32, bracket.columns.get_loc('Defense 2')] = bracket.iloc[2][['Defense 1']]    
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[32, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[2][['Win Pct 1']].values[0]
    ...
    if ff4_pred[0] <= ff4_pred[1]:
        ...
        bracket.iat[24, bracket.columns.get_loc('Team 2')] = ff4_team2.values[0]
        bracket.iat[24, bracket.columns.get_loc('Offense 2')] = bracket.iloc[3][['Offense 2']]
        bracket.iat[24, bracket.columns.get_loc('Defense 2')] = bracket.iloc[3][['Defense 2']]
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[24, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[3][['Win Pct 2']].values[0]
    else:
        #wins = int(bracket.iloc[2][['Wins 1']].values[0]) + 1
        #gp = int(bracket.iloc[2][['GP 1']].values[0]) + 1
        #winpct = float(bracket.iloc[2][['Wins 1']].values[0] / bracket.iloc[2][['GP 1']].values[0])
        ...
        bracket.iat[24, bracket.columns.get_loc('Team 2')] = ff4_team1.values[0]
        bracket.iat[24, bracket.columns.get_loc('Offense 2')] = bracket.iloc[3][['Offense 1']]
        bracket.iat[24, bracket.columns.get_loc('Defense 2')] = bracket.iloc[3][['Defense 1']]
        #bracket.iat[12, bracket.columns.get_loc('Wins 2')] = wins
        #bracket.iat[12, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[24, bracket.columns.get_loc('Win Pct 2')] = bracket.iloc[3][['Win Pct 1']].values[0]
    ...
    for a in range(32):
        source = a + r1s
        r1data = bracket.iloc[source][x_vars]
        #print(r1data)
        ...
        if r1pred[0] <= r1pred[1]:
            ...
            offense = bracket.iloc[source][['Offense 2']]
            defense = bracket.iloc[source][['Defense 2']]
            ...
            offense = bracket.iloc[source][['Offense 1']]
            defense = bracket.iloc[source][['Defense 1']]
    ...
    for b in range(16):
        source = b + r2s
        r2data = bracket.iloc[source][x_vars]
    ...
    for c in range(8):
        source = c + sss
        ssdata = bracket.iloc[source][x_vars]
        ...
        if sspred[0] <= sspred[1]:
            ...
            #wins = int(bracket.iloc[source][['Wins 2']].values[0]) + 1
            seed = bracket.iloc[source][['Seed 2']].values[0]
            ooffense = bracket.iloc[source][['Offense 2']]
            defense = bracket.iloc[source][['Defense 2']]
            #winpct = float(bracket.iloc[source][['Wins 2']].values[0] / bracket.iloc[source][['GP 2']].values[0])
            winpct = bracket.iloc[source][['Win Pct 2']].values[0]
        else:
    ...
    for d in range(4):
        source = d + ees
        eedata = bracket.iloc[source][x_vars]
    ...
    for e in range(2):
        source = e + ffs
        ffdata = bracket.iloc[source][x_vars]
    ...
    for e in range(2):
        source = cs
        cdata = bracket.iloc[source][x_vars]
