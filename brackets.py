...
def generate_bracket(output_file, model_name, name):
    ...
    if ff1_pred[0] <= ff1_pred[1]:
        ...
        gp = bracket.iloc[0][['GP 2']].values[0] + 1
        pts_for = bracket.iloc[0][['Points 2']].values[0] + int(ff1_pred[1])
        pts_ag = bracket.iloc[0][['Points Allowed 2']].values[0] + int(ff1_pred[0])
        bracket.iat[4, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[4, bracket.columns.get_loc('Points 2')] = pts_for
        ...
        gp = bracket.iloc[0][['GP 1']].values[0] + 1
        pts_for = bracket.iloc[0][['Points 1']].values[0] + int(ff1_pred[0])
        pts_ag = bracket.iloc[0][['Points Allowed 1']].values[0] + int(ff1_pred[1])
        bracket.iat[4, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[4, bracket.columns.get_loc('Points 2')] = pts_for
        bracket.iat[4, bracket.columns.get_loc('Points Allowed 2')] = pts_ag
        bracket.iat[4, bracket.columns.get_loc('Offense 2')] = recalculate_efficiency(pts_for, gp)
    ...
    # First Four - San Diego State vs North Carolina
    ...
    if ff2_pred[0] <= ff2_pred[1]:
        ...
        bracket.iat[8, bracket.columns.get_loc('Team 2')] = ff2_team2.values[0]
        gp = bracket.iloc[1][['GP 2']].values[0] + 1
        pts_for = bracket.iloc[1][['Points 2']].values[0] + int(ff1_pred[1])
        pts_ag = bracket.iloc[1][['Points Allowed 2']].values[0] + int(ff1_pred[0])
        bracket.iat[8, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[8, bracket.columns.get_loc('Points 2')] = pts_for
        ...
        bracket.iat[8, bracket.columns.get_loc('Team 2')] = ff2_team1.values[0]
        gp = bracket.iloc[1][['GP 1']].values[0] + 1
        pts_for = bracket.iloc[1][['Points 1']].values[0] + int(ff1_pred[0])
        pts_ag = bracket.iloc[1][['Points Allowed 1']].values[0] + int(ff1_pred[1])
        bracket.iat[8, bracket.columns.get_loc('GP 2')] = gp
        bracket.iat[8, bracket.columns.get_loc('Points 2')] = pts_for
        bracket.iat[8, bracket.columns.get_loc('Points Allowed 2')] = pts_ag
        bracket.iat[8, bracket.columns.get_loc('Offense 2')] = recalculate_efficiency(pts_for, gp)
    ...
    for a in range(32):
        ...
        if r1pred[0] <= r1pred[1]:
            ...
            pts_for = bracket.iloc[source][['Points 2']].values[0] + int(r1pred[1])
            pts_ag = bracket.iloc[source][['Points Allowed 2']].values[0] + int(r1pred[0])
            seed = bracket.iloc[source][['Seed 2']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            ...
            pts_for = bracket.iloc[source][['Points 1']].values[0] + int(r1pred[0])
            pts_ag = bracket.iloc[source][['Points Allowed 1']].values[0] + int(r1pred[1])
        ...
        if oe:
            ...
            bracket.iat[target, bracket.columns.get_loc('Points 2')] = pts_for
            bracket.iat[target, bracket.columns.get_loc('Points Allowed 2')] = pts_ag
            ...
            bracket.iat[target, bracket.columns.get_loc('Points 1')] = pts_for
            bracket.iat[target, bracket.columns.get_loc('Points Allowed 1')] = pts_ag
    ...
    for b in range(16):
        ...
        if r2pred[0] <= r2pred[1]:
            ...
            #wins = int(bracket.iloc[source][['Wins 2']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 2']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 2']].values[0] + int(r2pred[1])
            pts_ag = bracket.iloc[source][['Points Allowed 2']].values[0] + int(r2pred[0])
            seed = bracket.iloc[source][['Seed 2']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 2']].values[0] / bracket.iloc[source][['GP 2']].values[0])
            ...
            #wins = int(bracket.iloc[source][['Wins 1']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 1']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 1']].values[0] + int(r2pred[0])
            pts_ag = bracket.iloc[source][['Points Allowed 1']].values[0] + int(r2pred[1])
            seed = bracket.iloc[source][['Seed 1']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 1']].values[0] / bracket.iloc[source][['GP 1']].values[0])
    ...
    for c in range(8):
        ...
        if sspred[0] <= sspred[1]:
            ...
            #wins = int(bracket.iloc[source][['Wins 2']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 2']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 2']].values[0] + int(sspred[1])
            pts_ag = bracket.iloc[source][['Points Allowed 2']].values[0] + int(sspred[0])
            seed = bracket.iloc[source][['Seed 2']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 2']].values[0] / bracket.iloc[source][['GP 2']].values[0])
            ...
            #wins = int(bracket.iloc[source][['Wins 1']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 1']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 1']].values[0] + int(sspred[0])
            pts_ag = bracket.iloc[source][['Points Allowed 1']].values[0] + int(sspred[1])
            seed = bracket.iloc[source][['Seed 1']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 1']].values[0] / bracket.iloc[source][['GP 1']].values[0])
    ...
    for d in range(4):
        ...
        if eepred[0] <= eepred[1]:
            ...
            #wins = int(bracket.iloc[source][['Wins 2']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 2']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 2']].values[0] + int(eepred[1])
            pts_ag = bracket.iloc[source][['Points Allowed 2']].values[0] + int(eepred[0])
            seed = bracket.iloc[source][['Seed 2']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            ...
            #wins = int(bracket.iloc[source][['Wins 1']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 1']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 1']].values[0] + int(eepred[0])
            pts_ag = bracket.iloc[source][['Points Allowed 1']].values[0] + int(eepred[1])
            seed = bracket.iloc[source][['Seed 1']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 1']].values[0] / bracket.iloc[source][['GP 1']].values[0])
    ...
    for e in range(2):
        ...
        if ffpred[0] <= ffpred[1]:
            ...
            gp = int(bracket.iloc[source][['GP 2']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 2']].values[0] + int(ffpred[1])
            pts_ag = bracket.iloc[source][['Points Allowed 2']].values[0] + int(ffpred[0])
            seed = bracket.iloc[source][['Seed 2']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 2']].values[0] / bracket.iloc[source][['GP 2']].values[0])
            ...
            #wins = int(bracket.iloc[source][['Wins 1']].values[0]) + 1
            gp = int(bracket.iloc[source][['GP 1']].values[0]) + 1
            pts_for = bracket.iloc[source][['Points 1']].values[0] + int(ffpred[0])
            pts_ag = bracket.iloc[source][['Points Allowed 1']].values[0] + int(ffpred[1])
            seed = bracket.iloc[source][['Seed 1']].values[0]
            offense = recalculate_efficiency(pts_for, gp)
            defense = recalculate_efficiency(pts_ag, gp)
            #winpct = float(bracket.iloc[source][['Wins 1']].values[0] / bracket.iloc[source][['GP 1']].values[0])
